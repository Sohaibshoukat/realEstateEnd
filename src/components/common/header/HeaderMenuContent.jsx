...
const HeaderMenuContent = ({ float = "" }) => {
  ...
  const blog = [
    ...
    { id: 4, name: "Blog Details", routerPath: "/blog-details" },
  ];
  ...
  const pages = [
    ...
    { id: 7, name: "Developers", routerPath: "/developers" },
    { id: 8, name: "Register", routerPath: "/register" },
    { id: 9, name: "Service", routerPath: "/service" },
    { id: 10, name: "Projects", routerPath: "/projects" },
    { id: 11, name: "404 Page", routerPath: "/404" },
    { id: 12, name: "Terms & Conditions", routerPath: "/terms" },
  ];
  ...
  return (
    ...
    >
      ...
      <li className="dropitem">
        <Link href="/agency-v1">
          <a className="title">All Developers</a>
        </Link>
      </li>
      {/* End .dropitem */}
      ...
      <li className="dropitem">
        <Link href="/listing-map-v4">
          <a className="title">All Projects</a>
        </Link>
      </li>
      {/* End .dropitem */}
