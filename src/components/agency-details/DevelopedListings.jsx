...
import propertiesDetail from "../../data/properties";
...
const Listings = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const specificProperties = await propertiesDetail.filter(
        (item) =>
          item.developer === props.Developername && item.State === "delivered"
      );
      setProperties(specificProperties);
      setLoading(false);
    };
    fetchData();
  }, [props.Developername]);
